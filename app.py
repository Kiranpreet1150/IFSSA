...
# Thank You Page
def thank_you_page():
    st.title("🙏 Thank You IFSSA for your support and contribution to the society ")
    st.markdown("Thank you for using the IFSSA Client Retention Prediction App.")
    st.markdown("For more information, visit the [official IFSSA page](https://albertamentors.ca/islamic-family-social-services-association-ifssa/).")
    st.image("IFFSA_Family_2.png", use_container_width=True)
    st.image("IFFSA_Family_1.jpeg", use_container_width=True)
